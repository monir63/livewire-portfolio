            ...
            <thead>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="action">
                                <i wire:click="edit('{{ $banners->id }}')" data-bs-toggle="modal" href="#updatebanner" role="button" class="fa fa-pen"></i>
                                <i onclick="deleteAlert()" class="fa fa-times"></i>
                            </div>
                        </td>
                    </tr>

                    {{--Livewirre Banner Edit Modal Start --}}
                  ...
                  {{--Livewirre Banner Edit Modal End --}}
                    @endforeach
                </tbody>
                <tfoot>
                    <tr>
